-- @description TLC Find True Peaks (dBTP) in audio items
-- @version 1.0
-- @author Jordi Molas - The Little Cavern
-- @donation https://ko-fi.com/thelittlecavern
-- @about Analyzes audio items to find True Peaks, accounting for volume and envelopes. Creates a report track with markers at peak positions.
-- @changelog
--   # Initial release
--   * Added True Peak analysis and reporting.
...
function main()
    ...
    for i = 0, count_sel_items - 1 do
        ...
        if take and not reaper.TakeIsMIDI(take) then
            ...
            -- 2. Variables del motor matemÃ¡tico de volumen
            ...
            -- 3. AnÃ¡lisis de True Peaks (InterpolaciÃ³n CÃºbica Multicanal)
            ...
            while samplesRead < totalSamples do
                ...
                for j = 3, samplesToRead - 3, 50 do 
                    ...
                    if max_val_raw > 0.0001 then
                        ...
                        -- CORRECCIÃ“N APLICADA: Calculamos el volumen en el tiempo relativo
